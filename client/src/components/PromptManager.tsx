...
const PROMPT_LOCATIONS: Record<string, string> = {
  ...
  'foolproof_passive_inoculation': 'MindGames → Spot It → Cognitive Immunity Lab → Passive Inoculation',
  'foolproof_active_inoculation': 'MindGames → Spot It → Cognitive Immunity Lab → Active Inoculation',
